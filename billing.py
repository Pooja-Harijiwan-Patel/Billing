...
from tkinter import messagebox #for input validations
class Bill_App:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1350x700+0+0")
        self.root.title("Billing Software")
        #here color that i want to give to all frames is defined in this variable so i can use it in whole program
        bg_color="#074463"
        #In this line we are styling title of software by giving it font size,border and font color
        ...
        self.bill_no.set(str(x))#by passing this x we will get a random bill no of customer
        ...
        #This is for customer name entry field
        # bd for name field border and sunken for its shadow
        ...
        #This is for customer phone number field
        # bd for entry field border and sunken for its shadow
        ...
        #This is for customer bill id entry field
        # bd for entry field border and sunken for its shadow
        ...
        #=======Side Button ========,here we are using padx for giving to button from left and pady give space from below
        ...
        bath_lbl=Label(F2,text="Dettol Soap",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        bath_txt=Entry(F2,width=10,textvariable=self.soap,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=0,column=1,padx=10,pady=10)

        Face_cream_lbl=Label(F2,text="Nivea",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        Face_cream_txt=Entry(F2,width=10,textvariable=self.face_cream,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=10)

        Face_w_lbl=Label(F2,text="Gunsui",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        Hair_s_lbl=Label(F2,text="Nova Spray",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        Body_lbl=Label(F2,text="Ponds Lotion",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        g6_lbl=Label(F3,text="Tapal",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        c1_lbl=Label(F4,text="Dew",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        c1_txt=Entry(F4,width=10,textvariable=self.dew,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=0,column=1,padx=10,pady=10)
        ...
        c3_lbl=Label(F4,text="Sting",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        c3_txt=Entry(F4,width=10,textvariable=self.sting,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=2,column=1,padx=10,pady=10)

        c4_lbl=Label(F4,text="Coke",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        c4_txt=Entry(F4,width=10,textvariable=self.coke,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=3,column=1,padx=10,pady=10)
        ...
        m3_txt=Entry(F6,width=18,font="arial 10 bold",textvariable=self.beverages_price,bd=7,relief=SUNKEN).grid(row=2,column=1,padx=10,pady=1)
        ...
        c3_txt=Entry(F6,width=18,textvariable=self.beverages_tax,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=2,column=3,padx=10,pady=1)

        btn_F=Frame(F6,bd=7,relief=GROOVE)
        btn_F.place(x=750,width=580,height=105)

        total_btn=Button(btn_F,command=self.total,text="Total",bg="purple",fg="white",bd=2,pady=15,width=10,font="arial 15 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn=Button(btn_F,text="Generate Bill",command=self.bill_area,bg="purple",fg="white",bd=2,pady=15,width=10,font="arial 15 bold").grid(row=0,column=1,padx=5,pady=5)
        Clear_btn=Button(btn_F,text="Clear",command=self.clear_data,bg="purple",fg="white",bd=2,pady=15,width=10,font="arial 15 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit_btn=Button(btn_F,text="Exit",command=self.Exit_app,bg="purple",fg="white",bd=2,pady=15,width=10,font="arial 15 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()
    def total(self):         # And there we are storing those values in a variables so that we dont need to calculate it again & again
        self.c_s_p=self.soap.get()*40 # Here c_s_p means we are reffering that we have to calculate cosmetic (me soap ki price)
        self.c_fc_p=self.face_cream.get()*800
        self.c_fw_p=self.face_wash.get()*550
        self.c_hs_p=self.spray.get()*450
        self.c_hg_p=self.gell.get()*650
        self.c_bl_p=self.lotion.get()*450
        
        self.total_cosmetic_price=float(
                                     self.c_s_p+#In this we are calculating prices in for bill area 
                                     self.c_fc_p+
                                     self.c_fw_p+
                                     self.c_hs_p+
                                     self.c_hg_p+
        ...
        self.b_d_p=self.dew.get()*80
        self.b_s_p=self.sprite.get()*60
        self.b_t_p=self.sting.get()*60
        self.b_c_p=self.coke.get()*40
        self.b_p_p=self.pepsi.get()*50
        self.b_f_p=self.frooti.get()*80
    ...
    def welcome_bill(self): #this function will be called when we click on generate bill
        self.txtarea.delete('1.0',END)
        self.txtarea.insert(END,"\tWelcome Our Store\n")
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phone .get()=="":
        ...
        elif self.cosmetic_price.get()=="Rs. 0.0" and self.grocery_price.get()=="Rs. 0.0" and self.beverages_price.get()=="Rs. 0.0" :
            messagebox.showerror("Error!","No Product Purchased.")
        else:
            self.welcome_bill()
            #=======for price calculations of cosmetic products ======
            if self.soap.get()!=0:
                self.txtarea.insert(END,f"\n Dettol\t\t{self.soap.get()}\t\t{self.c_s_p}")
            if self.face_cream.get()!=0:
                self.txtarea.insert(END,f"\n Nivea\t\t{self.face_cream.get()}\t\t{self.c_fc_p}")
            if self.face_wash.get()!=0:
                self.txtarea.insert(END,f"\n Gunsui\t\t{self.face_wash.get()}\t\t{self.c_fw_p}")
            if self.spray.get()!=0:
                self.txtarea.insert(END,f"\n Nova\t\t{self.spray.get()}\t\t{self.c_hs_p}")
            if self.gell.get()!=0:
                self.txtarea.insert(END,f"\n Hair Gell\t\t{self.gell.get()}\t\t{self.c_hg_p}")
            if self.lotion.get()!=0:
                self.txtarea.insert(END,f"\n Ponds Lotion\t\t{self.lotion.get()}\t\t{self.c_bd_p}")

            #=======for price calculations of grocery products ======
            if self.rice.get()!=0:
            ...
            #=======for price calculations of beverages products ======
            if self.dew.get()!=0:
                self.txtarea.insert(END,f"\n Dew\t\t{self.rice.get()}\t\t{self.b_d_p}")
            if self.sprite.get()!=0:
                self.txtarea.insert(END,f"\n Sprite\t\t{self.sprite.get()}\t\t{self.b_s_p}")
            if self.sting.get()!=0:
                self.txtarea.insert(END,f"\n Sting\t\t{self.daal.get()}\t\t{self.b_t_p}")
            if self.coke.get()!=0:
                self.txtarea.insert(END,f"\n Coke\t\t{self.wheat.get()}\t\t{self.b_c_p}")
            if self.pepsi.get()!=0:
                self.txtarea.insert(END,f"\n Pepsi\t\t{self.sugar.get()}\t\t{self.b_p_p}")
            if self.frooti.get()!=0:
                self.txtarea.insert(END,f"\n Frooti\t\t{self.lotion.get()}\t\t{self.b_f_p}")
    ...
    def save_bill(self):
        ...
        if op>0:
            self.bill_data=self.txtarea.get('1.0',END)#giving index that the bill no. takes 1-0 numbers 
